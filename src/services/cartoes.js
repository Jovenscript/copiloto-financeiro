...
const colecao = (uid) => collection(db, 'users', uid, 'cartoes');
export function ouvirCartoes(uid, cb) {
...
export function atualizar(uid, id, p) { return updateDoc(doc(db, 'users', uid, 'cartoes', id), p); }
export function remover(uid, id) { return deleteDoc(doc(db, 'users', uid, 'cartoes', id)); }
